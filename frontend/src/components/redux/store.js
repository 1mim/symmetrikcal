...
import { fetchFoodDataReducer, filterByDateReducer, filterByMealTypesReducer, getMealLogsFromDbReducer, getTodayMealsReducer, logFoodToDbReducer, setFoodDataToLogReducer } from "./reducers/foodLogReducers";
...
const reducer = combineReducers({
    ...
    getTodayMeals: getTodayMealsReducer,
    filterByMealTypes: filterByMealTypesReducer,
